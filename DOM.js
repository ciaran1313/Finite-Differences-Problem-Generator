...
function displayNewProblem(){
  //setup
  problem = generateRandomFiniteDifferencesProblem();
  ...
  //switches button
  document.getElementById("check_button").style = null;
...
function revealSolution(){
  ...
  //reveals
  document.getElementById("equation").innerHTML = problem.equation.toHTML() + "<br/><br/>";
  ...
  document.getElementById("reset_button").style = null;
}
